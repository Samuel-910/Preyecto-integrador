<x-app-layout>
    @section('title', 'Practicante | Evidencia-Edit')
    <div class="w-full ml-10 mt-5 mb-10">
        <div class="text-white text-[32px] font-bold font-['Mulish']">Editar Evidencias</div>
        @if ($errors->any())
        ...
        <form action="{{ url('evidencias/'.$evidencia->id) }}" method="post" enctype="multipart/form-data" id="planForm">
            @method("PUT")
            @csrf
                ...
                <div class="mt-5">
                    ...
                    <div class="col-sm-5 mt-5">
                        <input type="date" class="w-[394px] h-[70px] pl-[115px] pr-[115px] pt-[20px] pb-[20px] bg-neutral-800 rounded-[10px] justify-start items-center inline-flex text-white text-opacity-50 text-2xl font-normal font-['Inter']" name="inicio" id="inicio" value="{{$evidencia->evi_inicio}}" required>
                    </div>
                </div>
                ...
                <div class="mt-5">
                    ...
                    <div class="col-sm-5 mt-5">
                        <input type="date" class="w-[394px] h-[70px] pl-[115px] pr-[115px] pt-[20px] pb-[20px] bg-neutral-800 rounded-[10px] justify-start items-center inline-flex text-white text-opacity-50 text-2xl font-normal font-['Inter']" name="fin" id="fin" value="{{$evidencia->evi_fin}}" required>
                    </div>
                </div>
                ...
                <div class="mt-5">
                    ...
                    <div class="col-sm-5 mt-5">
                        <input type="text" class="w-[394px] h-[70px] pl-[115px] pr-[115px] pt-[20px] pb-[20px] bg-neutral-800 rounded-[10px] justify-start items-center inline-flex text-white text-opacity-50 text-2xl font-normal font-['Inter']" name="horas" id="horas" value="{{$evidencia->evi_horas}}" required placeholder="20">
                    </div>
                </div>
                ...
                <div class="mt-5">
                    ...
                    <div class="col-sm-5 mt-5">
                        <textarea
                            ...
                            name="descripcion" id="descripcion" required placeholder="Informe detallado que respalda la participación activa y los logros obtenidos durante mis prácticas profesionales">{{$evidencia->evi_descripcion}}</textarea>
                    </div>
                </div>
