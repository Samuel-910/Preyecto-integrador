<x-app-layout>
    ...
    <div class="w-full ml-10 mt-5 mb-10">
        <div class="text-white text-[50px] font-bold font-['Mulish']">Subir Plan Inicial</div>
        @if ($errors->any())
        ...
        <form action="{{ url('planppp') }}" method="post" enctype="multipart/form-data" id="planForm">
            @csrf
                ...
                <div>
                    ...
                    <div class="mt-5">
                        ...
                        <div class="col-sm-5 mt-5">
                            <input type="text"
                                class="w-[394px] h-[70px] pl-[115px] pr-[115px] pt-[20px] pb-[20px] bg-neutral-800 rounded-[10px] justify-start items-center inline-flex text-white text-opacity-50 text-2xl font-normal font-['Inter']"
                                name="horas" id="horas" value="{{ old('horas') }}" required placeholder="200">
                        </div>
                    </div>
                    ...
                    <div class="mt-5">
                        ...
                        <div class="col-sm-5 mt-5">
                            <select class="w-[394px] h-[70px] bg-neutral-800 rounded-[10px] text-white text-opacity-50 text-2xl font-normal font-['Inter']"
                                ...
                                <option value="1" {{ old('modalidad') == 'Virtual' ? 'selected' : '' }}>Virtual</option>
                                <option value="2" {{ old('modalidad') == 'Presencial' ? 'selected' : '' }}>Presencial</option>
                                <option value="3" {{ old('modalidad') == 'Semipresencial' ? 'selected' : '' }}>Semipresencial</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="mt-5">
                        ...
                        <div class="col-sm-5 mt-5">
                            <select
                                ...
                                <option value="" {{ old('modalidad') == '' ? 'selected' : '' }}>Seleccionar</option>
                                <option value="1" {{ old('turno') == 'Mañana' ? 'selected' : '' }}>Mañana</option>
                                <option value="2" {{ old('turno') == 'Tarde' ? 'selected' : '' }}>Tarde</option>
                            </select>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <div class="mt-5">
                        ...
                        <div class="col-sm-5 mt-5">
                            <input type="text"
                                class="w-[394px] h-[70px] pl-[115px] pr-[115px] pt-[20px] pb-[20px] bg-neutral-800 rounded-[10px] justify-start items-center inline-flex text-white text-opacity-50 text-2xl font-normal font-['Inter']"
                                name="nombre" id="nombre" value="{{ old('nombre') }}" required placeholder="Juan Perez">
                        </div>
                    </div>
                    ...
                    <div class="mt-5">
                        ...
                        <div class="col-sm-5 mt-5">
                            <input type="text"
                                class="w-[394px] h-[70px] pl-[115px] pr-[115px] pt-[20px] pb-[20px] bg-neutral-800 rounded-[10px] justify-start items-center inline-flex text-white text-opacity-50 text-2xl font-normal font-['Inter']"
                                name="numero" id="numero" value="{{ old('numero') }}" required placeholder="987654321">
                        </div>
                    </div>
                </div>
            </div>
